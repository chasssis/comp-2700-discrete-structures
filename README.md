...
lab 2 checks whether a relation is a valid function between sets, determines its range, tests whether it is one-to-one or onto, computes its inverse if it is bijective, and then runs a series of test cases to verify each behavior.
Lab 3 is an implementation of RSA encryption.
